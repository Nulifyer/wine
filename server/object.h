...
extern struct object *create_semaphore_sync( unsigned int initial, unsigned int max );
extern void release_semaphore_sync( struct object *sync, unsigned int count );
extern void release_inproc_semaphore_sync( struct inproc_sync *sync, unsigned int count );
