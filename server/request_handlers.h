...
C_ASSERT( sizeof(struct alpc_message_info) == 48 );
...
C_ASSERT( offsetof(struct new_process_request, native_session) == 40 );
C_ASSERT( offsetof(struct new_process_request, protection) == 44 );
C_ASSERT( offsetof(struct new_process_request, info_size) == 48 );
C_ASSERT( offsetof(struct new_process_request, handles_size) == 52 );
C_ASSERT( offsetof(struct new_process_request, jobs_size) == 56 );
...
C_ASSERT( offsetof(struct get_process_info_reply, base_priority) == 57 );
C_ASSERT( offsetof(struct get_process_info_reply, disable_boost) == 58 );
...
C_ASSERT( offsetof(struct open_file_object_request, disposition) == 16 );
C_ASSERT( offsetof(struct open_file_object_request, sharing) == 20 );
C_ASSERT( offsetof(struct open_file_object_request, options) == 24 );
C_ASSERT( offsetof(struct open_file_object_request, async_user) == 32 );
C_ASSERT( offsetof(struct open_file_object_request, impersonation_level) == 40 );
C_ASSERT( offsetof(struct open_file_object_request, context_tracking) == 44 );
C_ASSERT( offsetof(struct open_file_object_request, effective_only) == 48 );
C_ASSERT( sizeof(struct open_file_object_request) == 56 );
C_ASSERT( offsetof(struct open_file_object_reply, handle) == 8 );
C_ASSERT( offsetof(struct open_file_object_reply, wait) == 12 );
C_ASSERT( offsetof(struct open_file_object_reply, information) == 16 );
C_ASSERT( sizeof(struct open_file_object_reply) == 24 );
...
C_ASSERT( offsetof(struct filter_token_request, disable_size) == 24 );
C_ASSERT( sizeof(struct filter_token_request) == 32 );
...
C_ASSERT( offsetof(struct get_token_groups_request, restricted) == 20 );
...
C_ASSERT( offsetof(struct alpc_connect_port_request, message_context) == 56 );
C_ASSERT( sizeof(struct alpc_connect_port_request) == 64 );
