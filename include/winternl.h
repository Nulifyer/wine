...
typedef struct _RTL_USER_PROCESS_EXTENDED_PARAMETERS
{
  USHORT Version;
  USHORT NodeNumber;
  SECURITY_DESCRIPTOR *ProcessSecurityDescriptor;
...
NTSYSAPI NTSTATUS  WINAPI NtAlpcSetInformation(HANDLE,ULONG,void *,ULONG);
...
{
    ULONGLONG SubscriptionId, StateName;
    ULONG ChangeStamp, StateDataSize, EventMask;
    GUID TypeId;
    ULONG StateDataOffset;
} WNF_DELIVERY_DESCRIPTOR;
NTSYSAPI NTSTATUS WINAPI NtSubscribeWnfStateChange(const ULONGLONG*,ULONG,ULONG,ULONGLONG*);
NTSYSAPI NTSTATUS WINAPI NtUnsubscribeWnfStateChange(const ULONGLONG*);
NTSYSAPI NTSTATUS WINAPI NtSetWnfProcessNotificationEvent(HANDLE);
NTSYSAPI NTSTATUS WINAPI NtQueryWnfStateNameInformation(const ULONGLONG*,ULONG,const void*,void*,ULONG);
NTSYSAPI NTSTATUS WINAPI NtGetCompleteWnfStateSubscription(const ULONGLONG*,const ULONGLONG*,ULONG,ULONG,WNF_DELIVERY_DESCRIPTOR*,ULONG);
NTSYSAPI NTSTATUS  WINAPI NtCreateWnfStateName(ULONGLONG*,ULONG,ULONG,BOOLEAN,const GUID*,ULONG,const SECURITY_DESCRIPTOR*);
NTSYSAPI NTSTATUS  WINAPI NtDeleteWnfStateName(const ULONGLONG*);
NTSYSAPI NTSTATUS  WINAPI NtQueryWnfStateData(const ULONGLONG*,const GUID*,const void*,ULONG*,void*,ULONG*);
NTSYSAPI NTSTATUS  WINAPI NtUpdateWnfStateData(const ULONGLONG*,const void*,ULONG,const GUID*,const void*,ULONG,ULONG);
...
NTSYSAPI NTSTATUS  WINAPI NtSerializeBoot(void);
...
NTSYSAPI NTSTATUS  WINAPI RtlAddMandatoryAce(PACL,DWORD,DWORD,PSID,BYTE,DWORD);
NTSYSAPI NTSTATUS  WINAPI RtlAddProcessTrustLabelAce(PACL,DWORD,DWORD,PSID,BYTE,DWORD);
...
NTSYSAPI NTSTATUS  WINAPI RtlAcquirePrivilege(const ULONG*,ULONG,ULONG,void**);
NTSYSAPI NTSTATUS  WINAPI RtlAdjustPrivilege(ULONG,BOOLEAN,BOOLEAN,PBOOLEAN);
NTSYSAPI NTSTATUS  WINAPI RtlRemovePrivileges(HANDLE,const ULONG *,ULONG);
...
NTSYSAPI NTSTATUS  WINAPI RtlConnectToSm(UNICODE_STRING*,HANDLE,ULONG,HANDLE*);
...
NTSYSAPI BOOLEAN   WINAPI RtlCreateHashTable(PRTL_DYNAMIC_HASH_TABLE*,ULONG,ULONG);
...
NTSYSAPI NTSTATUS  WINAPI RtlCreateUserProcessEx(UNICODE_STRING*,RTL_USER_PROCESS_PARAMETERS*,BOOLEAN,RTL_USER_PROCESS_EXTENDED_PARAMETERS*,RTL_USER_PROCESS_INFORMATION*);
NTSYSAPI NTSTATUS  WINAPI RtlCreateUserStack(SIZE_T,SIZE_T,ULONG,SIZE_T,SIZE_T,INITIAL_TEB*);
NTSYSAPI ULONG     WINAPI RtlCreateTagHeap(HANDLE,ULONG,const WCHAR*,const WCHAR*);
...
NTSYSAPI BOOLEAN   WINAPI RtlDeleteHashTable(PRTL_DYNAMIC_HASH_TABLE);
...
NTSYSAPI void      WINAPI RtlEndEnumerationHashTable(PRTL_DYNAMIC_HASH_TABLE,PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR);
NTSYSAPI NTSTATUS  WINAPI RtlEnterCriticalSection(RTL_CRITICAL_SECTION *);
NTSYSAPI PRTL_DYNAMIC_HASH_TABLE_ENTRY WINAPI RtlEnumerateEntryHashTable(PRTL_DYNAMIC_HASH_TABLE,PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR);
...
NTSYSAPI PRTL_DYNAMIC_HASH_TABLE_ENTRY WINAPI RtlGetNextEntryHashTable(PRTL_DYNAMIC_HASH_TABLE,PRTL_DYNAMIC_HASH_TABLE_CONTEXT);
...
NTSYSAPI ULONG     WINAPI RtlGetCurrentServiceSessionId(void);
...
NTSYSAPI NTSTATUS  WINAPI RtlGetPersistedStateLocation(PCWSTR,PCWSTR,PCWSTR,ULONG,PWSTR,ULONG,PULONG);
...
NTSYSAPI NTSTATUS  WINAPI RtlGetSystemBootStatus(ULONG,void*,ULONG,ULONG*);
...
NTSYSAPI ULONG     WINAPI RtlGetSuiteMask(void);
...
NTSYSAPI BOOLEAN   WINAPI RtlInitEnumerationHashTable(PRTL_DYNAMIC_HASH_TABLE,PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR);
NTSYSAPI BOOLEAN   WINAPI RtlInsertEntryHashTable(PRTL_DYNAMIC_HASH_TABLE,PRTL_DYNAMIC_HASH_TABLE_ENTRY,ULONG_PTR,PRTL_DYNAMIC_HASH_TABLE_CONTEXT);
...
NTSYSAPI BOOLEAN   WINAPI RtlIsMultiSessionSku(void);
NTSYSAPI BOOLEAN   WINAPI RtlIsMultiUsersInSessionSku(void);
...
NTSYSAPI BOOLEAN   WINAPI RtlIsStateSeparationEnabled(void);
NTSYSAPI BOOLEAN   WINAPI RtlIsTextUnicode(LPCVOID,INT,INT *);
NTSYSAPI BOOLEAN   WINAPI RtlIsThreadWithinLoaderCallout(void);
...
NTSYSAPI PRTL_DYNAMIC_HASH_TABLE_ENTRY WINAPI RtlLookupEntryHashTable(PRTL_DYNAMIC_HASH_TABLE,ULONG_PTR,PRTL_DYNAMIC_HASH_TABLE_CONTEXT);
...
NTSYSAPI NTSTATUS  WINAPI RtlPublishWnfStateData(ULONGLONG,const GUID*,const void*,ULONG,const void*);
...
NTSYSAPI NTSTATUS  WINAPI RtlQueryElevationFlags(ULONG*);
...
NTSYSAPI void      WINAPI RtlReleasePrivilege(void*);
...
NTSYSAPI BOOLEAN   WINAPI RtlRemoveEntryHashTable(PRTL_DYNAMIC_HASH_TABLE,PRTL_DYNAMIC_HASH_TABLE_ENTRY,PRTL_DYNAMIC_HASH_TABLE_CONTEXT);
...
NTSYSAPI NTSTATUS  WINAPI RtlSendMsgToSm(HANDLE,ALPC_PORT_MESSAGE*);
...
NTSYSAPI NTSTATUS  WINAPI RtlSetEnvironmentVar(WCHAR**,const WCHAR*,SIZE_T,const WCHAR*,SIZE_T);
...
NTSYSAPI NTSTATUS  WINAPI RtlSetProcessIsCritical(BOOLEAN,BOOLEAN*,BOOLEAN);
...
NTSYSAPI NTSTATUS  WINAPI RtlSetThreadIsCritical(BOOLEAN,BOOLEAN*,BOOLEAN);
...
NTSYSAPI NTSTATUS  WINAPI RtlTestAndPublishWnfStateData(ULONGLONG,const GUID*,const void*,ULONG,const void*,ULONG);
